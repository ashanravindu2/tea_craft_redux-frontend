...
function ViewEmployee({ isOpenModal, setIsOpenModal, employee }: Readonly<ViewEmployeeProps>) {
    return (
        isOpenModal && (
            <motion.div
